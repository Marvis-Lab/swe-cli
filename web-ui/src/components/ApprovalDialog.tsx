...
export function ApprovalDialog() {
  ...
  return (
    <div className="fixed inset-0 bg-black/20 backdrop-blur-sm flex items-center justify-center z-50 animate-fade-in">
      <div className="bg-bg-000 rounded-xl shadow-2xl border border-border-300/15 max-w-2xl w-full mx-4 animate-slide-up">
        {/* Header */}
        ...
        {/* Footer - 3 Options */}
        <div className="border-t border-border-300/15 px-6 py-5 bg-bg-100">
