"""DockerToolRegistry - Routes tool calls to Docker runtime.

This registry wraps DockerToolHandler to provide a compatible interface
with the standard ToolRegistry.
"""
