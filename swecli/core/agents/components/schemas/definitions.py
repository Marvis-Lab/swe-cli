...
_BUILTIN_TOOL_SCHEMAS: list[dict[str, Any]] = [
    ...
    # Skills System Tool
    {
        ...
        "function": {
            "name": "invoke_skill",
            "description": (
                "Load a skill's knowledge and instructions into the current conversation "
                "context. Skills only need to be loaded ONCE per conversation — after loading, "
                "the content remains available. Use the loaded content to guide your next "
                "actions. Call without skill_name to list available skills."
            ),
            "parameters": {
                "type": "object",
                "properties": {
