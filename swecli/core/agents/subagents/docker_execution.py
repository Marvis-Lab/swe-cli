"""Docker execution handler for subagents."""
...
class DockerSubAgentExecutor:
    """Handles execution of subagents within Docker containers."""

    def __init__(self, manager: SubAgentManager) -> None:
        """Initialize the DockerSubAgentExecutor.
    ...
    def _rewrite_task_for_docker(
        ...
        local_working_dir = self._manager._working_dir
...
"""
    ...
    def create_docker_nested_callback(
        ...
        path_sanitizer = self._create_docker_path_sanitizer(
            ...
            local_dir=local_dir or str(self._manager._working_dir or Path.cwd()),
    ...
    def execute_lifecycle(
        ...
        Args:
            ...
            local_output_dir: Local directory where files should be copied after Docker
                execution. If None, uses self._manager._working_dir or cwd.
        ...
        local_working_dir = local_output_dir or (Path(self._manager._working_dir) if self._manager._working_dir else Path.cwd())
        ...
        if show_spawn_header:
            spawn_args = {
                "subagent_type": name,
                "description": self._manager._extract_task_description(task),
            }
        ...
        try:
            ...
            result = self._manager.execute_subagent(
                name=name,
