...
class SymbolCacheManager:
    ...
    def __init__(
        self,
        cache_dir: Path,
        cache_version_raw_document_symbols: Hashable,
    ):
    ...
    def get_raw_document_symbols(
        self, cache_key: str, content_hash: str
    ...
    def get_document_symbols(self, cache_key: str, content_hash: str) -> Optional[DocumentSymbols]:
    ...
    def _load_raw_document_symbols_cache(self) -> None:
        ...
        if not cache_file.exists():
            ...
            if legacy_cache_file.exists():
                try:
                    legacy_cache = load_pickle(legacy_cache_file)
