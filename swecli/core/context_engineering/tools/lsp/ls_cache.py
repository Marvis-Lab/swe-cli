...
class LanguageServerCache:
    ...
    def update_raw_document_symbols(
        self, cache_key: str, content_hash: str, symbols: list[DocumentSymbol] | list[SymbolInformation] | None
    ) -> None:
    ...
    def update_document_symbols(self, cache_key: str, content_hash: str, symbols: DocumentSymbols) -> None:
        log.debug("Updating cached document symbols for %s", cache_key)
        self._document_symbols_cache[cache_key] = (content_hash, symbols)
