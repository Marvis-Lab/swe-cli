...
class SolidLanguageServer(ABC):
    ...
    def __init__(
        ...
        self.symbol_cache_manager = SymbolCacheManager(
            cache_dir=cache_dir,
            cache_version_raw_document_symbols=cache_version_raw_document_symbols,
        )
    ...
    def _request_document_symbols(
        ...
        def get_raw_document_symbols(fd: LSPFileBuffer) -> list[SymbolInformation] | list[DocumentSymbol] | None:
            ...
            response = self.symbol_cache_manager.get_raw_document_symbols(cache_key, fd.content_hash)
            ...
            # update cache
            self.symbol_cache_manager.update_raw_document_symbols(cache_key, fd.content_hash, response)
    ...
    def request_document_symbols(self, relative_file_path: str, file_buffer: LSPFileBuffer | None = None) -> DocumentSymbols:
        ...
        with self._open_file_context(relative_file_path, file_buffer) as file_data:
            ...
            cache_key = relative_file_path
            document_symbols = self.symbol_cache_manager.get_document_symbols(cache_key, file_data.content_hash)
            ...
            # update cache
            self.symbol_cache_manager.update_document_symbols(cache_key, file_data.content_hash, document_symbols)
    ...
    def save_cache(self) -> None:
        self.symbol_cache_manager.save_cache()
