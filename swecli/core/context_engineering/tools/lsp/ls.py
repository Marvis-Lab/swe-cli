...
class SolidLanguageServer(ABC):
    ...
    def __init__(
        ...
        self.symbol_cache_manager = SymbolCacheManager(self.cache_dir, cache_version_raw_document_symbols)
    ...
    def _request_document_symbols(
        ...
        def get_cached_raw_document_symbols(cache_key: str, fd: LSPFileBuffer) -> list[SymbolInformation] | list[DocumentSymbol] | None:
            result = self.symbol_cache_manager.get_raw_document_symbols(cache_key, fd.content_hash)
    ...
    def save_cache(self) -> None:
        self.symbol_cache_manager.save()
