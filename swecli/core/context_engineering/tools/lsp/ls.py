...
from swecli.core.context_engineering.tools.lsp.ls_cache import DocumentSymbols, LSCacheMixin
...
class SolidLanguageServer(LSCacheMixin, ABC):
    """
    ...
    def __init__(
        ...
        self._init_caches(cache_version_raw_document_symbols)
