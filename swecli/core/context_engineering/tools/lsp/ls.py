...
from swecli.core.context_engineering.tools.lsp.util.compat import MatchedConsecutiveLines, match_path
...
from swecli.core.context_engineering.tools.lsp.ls_structs import DocumentSymbols, GenericDocumentSymbol, LSPFileBuffer, ReferenceInSymbol
...
class SolidLanguageServer(ABC):
    ...
    def __init__(
        ...
        self.ls_cache = LanguageServerCache(self.cache_dir, cache_version_raw_document_symbols)
        self.ls_cache.load_caches()
    ...
    def _request_document_symbols(
        ...
        def get_raw_document_symbols(fd: LSPFileBuffer) -> list[SymbolInformation] | list[DocumentSymbol] | None:
            ...
            response = self.ls_cache.get_raw_document_symbols(cache_key, fd.content_hash)
            ...
            # update cache
            self.ls_cache.update_raw_document_symbols(cache_key, fd.content_hash, response)
    ...
    def request_document_symbols(self, relative_file_path: str, file_buffer: LSPFileBuffer | None = None) -> DocumentSymbols:
        ...
        with self._open_file_context(relative_file_path, file_buffer) as file_data:
            ...
            cache_key = relative_file_path
            document_symbols = self.ls_cache.get_document_symbols(cache_key, file_data.content_hash)
            if document_symbols is not None:
            ...
            # update cache
            self.ls_cache.update_document_symbols(cache_key, file_data.content_hash, document_symbols)
