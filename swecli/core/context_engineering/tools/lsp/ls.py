...
from swecli.core.context_engineering.tools.lsp.util.compat import load_pickle, MatchedConsecutiveLines, match_path
...
class SolidLanguageServer(ABC):
    ...
    def __init__(
        ...
        self.cache = LanguageServerCache(self.cache_dir, cache_version_raw_document_symbols)
    ...
    def _request_document_symbols(
        ...
        def get_raw_document_symbols(fd: LSPFileBuffer) -> list[SymbolInformation] | list[DocumentSymbol] | None:
            ...
            response = self.cache.get_raw_document_symbols(cache_key, fd.content_hash)
            ...
            # update cache
            self.cache.update_raw_document_symbols(cache_key, fd.content_hash, response)
    ...
    def request_document_symbols(self, relative_file_path: str, file_buffer: LSPFileBuffer | None = None) -> DocumentSymbols:
        ...
        with self._open_file_context(relative_file_path, file_buffer) as file_data:
            ...
            cache_key = relative_file_path
            document_symbols = self.cache.get_document_symbols(cache_key, file_data.content_hash)
            ...
            # update cache
            self.cache.update_document_symbols(cache_key, file_data.content_hash, document_symbols)
