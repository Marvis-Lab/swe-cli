"""ACE Processor for managing Agent-Computer Interface logic."""
...
class ACEProcessor:
    """Delegates Agent-Computer Interface (ACE) logic."""
    ...
    def __init__(self, session_manager: "SessionManager"):
        ...
        Args:
            session_manager: Session manager to access current session and playbook.
        """
    ...
    def init_components(self, agent):
    ...
    def set_last_agent_response(self, response: Optional[AgentResponse]):
        """Set the last agent response for learning context.

        Args:
            response: The agent response to store.
        """
