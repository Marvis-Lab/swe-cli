"""ACE Processor for handling Agentic Context Engineering logic."""
...
class ACEProcessor:
    """Handles Agentic Context Engineering (ACE) logic."""
    ...
    def init_ace_components(self, agent) -> None:
    ...
    def set_last_agent_response(self, content: str, tool_calls: list) -> None:
        ...
        Args:
            ...
            tool_calls: The list of tool calls in the response
        """
    ...
    def record_tool_learnings(
        ...
        try:
            ...
            self.init_ace_components(agent)
