"""ACE Processor for handling Agent-Computer Interface learning loop."""
...
class ACEProcessor:
    """Handles the ACE learning loop: Reflection -> Curation -> Playbook Evolution."""
    ...
    def set_last_agent_response(self, content: str, tool_calls: list):
