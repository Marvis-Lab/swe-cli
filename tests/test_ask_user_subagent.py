...
from swecli.core.agents.subagents.agents.ask_user import ASK_USER_SUBAGENT, ASK_USER_SYSTEM_PROMPT
...
class TestAskUserSubAgentManagerIntegration:
    ...
    def test_ask_user_has_system_prompt(self):
        ...
        assert len(ASK_USER_SUBAGENT["system_prompt"]) > 0
        assert "Purpose" in ASK_USER_SYSTEM_PROMPT
        assert "Question Structure" in ASK_USER_SYSTEM_PROMPT
